...
public class ListMockTest {
    ...
    void mocking() {
        ...
        System.out.println("arrayListMock.get(0) = " + arrayListMock.get(0));
        System.out.println("arrayListMock.size() = " + arrayListMock.size());
    ...
    void spying() {
        ...
        System.out.println("arrayListSpy.get(0) = " + arrayListSpy.get(0));
